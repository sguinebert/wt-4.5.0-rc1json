...
namespace Wt
{
  ...
  int WDate::toJulianDay() const
  {
    ...
    else
    {
      ...
      return day() + std::floor((153 * nmonths + 2) / 5) + 365 * nyears + std::floor(nyears / 4) - std::floor(nyears / 100) + std::floor(nyears / 400) - 32045;
    }
  }
  ...
  {
    static const char *v[] = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday",
                              "Sunday"};
                         ...
                         const WString &format, int &currentGroup)
    {
      if (d != 0)
      {
        ...
        case 2:
          ...
          result.dayGetJS = "return parseInt(results[" + std::to_string(currentGroup++) + "], 10);";
          break;
        default:
      ...
      if (M != 0)
      {
        ...
        case 2:
          ...
          result.monthGetJS = "return parseInt(results[" + std::to_string(currentGroup++) + "], 10);";
          break;
        default:
      ...
      if (y != 0)
      {
        ...
        case 2:
          result.regexp += "(\\d{2})";
          result.yearGetJS = "var y=parseInt(results[" + std::to_string(currentGroup++) + "], 10);"
                                                                                          "return y > 38 ? 1900 + y : 2000 + y;";
          break;
        case 4:
          result.regexp += "(\\d{4})";
          result.yearGetJS = "return parseInt(results[" + std::to_string(currentGroup++) + "], 10)";
          break;
        default:
