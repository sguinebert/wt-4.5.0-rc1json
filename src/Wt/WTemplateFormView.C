...
namespace Wt
{
  ...
  void WTemplateFormView ::setFormWidget(WFormModel::Field field, std::unique_ptr<WWidget> formWidget,
  ...
  std::unique_ptr<WWidget> WTemplateFormView ::createFormWidget(WFormModel::Field field)
  {
                                             ...
                                             const WValidator::Result &validation)
  {
    ...
    if (validated)
    {
      WApplication::instance()->theme()->applyValidationStyle(edit, validation, ValidationAllStyles);
    ...
    {
      WApplication::instance()->theme()->applyValidationStyle(edit, validation, None);
