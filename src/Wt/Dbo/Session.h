 ...
 */
    ...
    class SqlStatement;
    template <typename Result, typename BindStrategy>
    class Query;
 ...
 */
   ...
   */
      template <class C>
      ptr<C> add(std::unique_ptr<C> obj);
   ...
   */
    ...
    private:
      ...
      template <class C>
      void prune(MetaDbo<C> *obj);

      template <class C>
      void implSave(MetaDbo<C> &dbo);
      template <class C>
      void implDelete(MetaDbo<C> &dbo);
      template <class C>
      void implTransactionDone(MetaDbo<C> &dbo, bool success);
      template <class C>
      void implLoad(MetaDbo<C> &dbo, SqlStatement *statement, int &column);
      template <class C>
      void implUpdate(MetaDbo<C> &dbo);
      ...
      template <class C>
      std::string manyToManyJoinId(const std::string &joinName,
      ...
      template <class C>
      friend class Impl::QueryBase;
      template <class C, typename T>
      friend struct Impl::LoadHelper;
      template <typename V>
      friend class FieldRef;
      template <class C>
      friend struct query_result_traits;
      template <class C>
      friend class SaveDbAction;
      template <class C>
      friend class LoadDbAction;
      template <class C>
      friend class UpdateBaseAction;
      template <class C>
      friend class PtrRef;
