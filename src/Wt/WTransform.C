...
namespace Wt
{
  ...
  {
    return !isJavaScriptBound() && (m_[M11] == 1.0) && (m_[M22] == 1.0) && (m_[M21] == 0.0) && (m_[M12] == 0.0) && (m_[M13] == 0.0) && (m_[M23] == 0.0);
  }
...
#define M_PI 3.14159265358979323846
  ...
  WTransform &WTransform::operator*=(const WTransform &Y)
  {
    ...
    double z13 = X.m_[M11] * Y.m_[M13] + X.m_[M12] * Y.m_[M23] + X.m_[M13] /* * Y.m_[M33]=1*/;
    ...
    double z23 = X.m_[M21] * Y.m_[M13] + X.m_[M22] * Y.m_[M23] + X.m_[M23] /* * Y.m_[M33]=1*/;
